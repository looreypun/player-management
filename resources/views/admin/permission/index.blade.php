...
@section('content')
    <div id="permission-index" v-cloak>
        {{-- メッセージ --}}
                            ...
                            <table class="table table-striped table-sm">
                                ...
                                <tr v-for="row in response" :key="row.id">
                                    <template v-if="row.edit_mode">
                                        <td>@{{ row.id }}</td>
                                        <td>
                                            <input type="text" class="form-control d-inline" name="name" v-model="row.name" :class="{ 'is-invalid': errors.name }" placeholder="Permission name" />
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-danger">
                                <h5 class="modal-title text-end">ADD PERMISSION</h5>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="text" class="form-control d-inline" name="permission" v-model="permission" :class="{ 'is-invalid': errors.permission }" placeholder="Permission Name" />
...
@section('js')
    <script src="{{ asset('js/admin/permission/index.js') . '?' . md5_file('js/admin/permission/index.js') }}"></script>
@stop
